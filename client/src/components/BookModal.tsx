...
export default function BookModal(props: ModalProps) {
  ...
  return (
    <div id={props.id}
      className={"absolute h-screen w-screen m-0 p-0 flex justify-center items-center left-0 top-0 bg-gray-600/60 z-40" + (props.show ? "" : " hidden")} >
      <div className="md:max-h-5/6 mb-auto md:my-auto md:w-3/4 lg:w-1/3 mx-auto px-8 py-4 bg-gray-200">
        <form action="">
          ...
          <div className="flex items-center mb-5">
            ...
            <select className="flex-1 p-2 border-b-2 border-gray-400 focus:border-sky-500 text-gray-600 placeholder-gray-400 outline-none bg-white">
          ...
          <div className="text-right pb-6">
            ...
            <button className="py-3 px-8 bg-indigo-600 hover:bg-indigo-500 border-indigo-600 hover:border-indigo-500 border-2 text-white font-bold ml-4">Guardar</button>
          </div>
        </form>
      </div>
    </div>
